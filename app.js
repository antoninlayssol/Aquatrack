...
const firebaseConfig = {
  ...
  // IMPORTANT : même base que l'ESP32
...
// Prix plus précis pour les petites consommations
...
function renderCurrentSession(data) {
  ...
  // Prix affiché au milieu avec précision
...
function renderHistory(sessionsObject) {
  ...
  elements.history.innerHTML = sessions
    .map((session) => {
      ...
      // Prix affiché dans l'historique avec précision
