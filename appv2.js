...
// Initialisation de la liste avec tes nouveaux prénoms demandés
let USERS = [
  { id: "u1", name: "Wang" },
  { id: "u2", name: "Shafiq" },
  { id: "u3", name: "Antonin" },
...
// Fonction de génération dynamique de la liste des boutons
function renderUserGrid() {
  ...
  // Réattache les écouteurs sur les nouveaux éléments HTML injectés
...
function handleAddUser() {
  ...
  // Préserve le focus utilisateur sélectionné si une douche est active
...
// Écouteurs d'événements pour le nouveau module
...
function renderCurrentSession(data) {
  ...
  // Synchro si un utilisateur externe inconnu est enregistré dans currentSession
